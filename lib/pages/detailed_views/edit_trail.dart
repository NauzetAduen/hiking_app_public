...
import 'package:hiking_app/pages/new_views/new_trail_map.dart';
...
class EditTrail extends StatefulWidget {
  final Trail t;
  final String documentID;

  const EditTrail(this.t, this.documentID);
  @override
  _EditTrailState createState() => _EditTrailState();
}

class _EditTrailState extends State<EditTrail> {
  ...
  void initState() {
    super.initState();
    nameController.text = widget.t.trailName;
    descController.text = widget.t.description;
    distanceController.text = widget.t.distanceInMeters.toString();
    difficultyController.text = widget.t.dificulty.toString();
    newTrail.markers = widget.t.markers;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: LeadingAppbar(
            Text("Editing trail", style: Styles.appbarTextStyleWithLetterSpacing)),
        body: Container(
        ...
        children: <Widget>[
          ...
          GradientButton(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: <Widget>[
                Text("Update", style: Styles.titleTextStyle),
  ...
  void _updateTrail(){
    ...
    Firestore.instance.runTransaction((Transaction transaction) async {
      ...
      await transaction.update(snapshot.reference, {
        "trailName": finalTrail.trailName,
        "description": finalTrail.description,
        "markers": finalTrail.markers,
        "distanceInMeters": finalTrail.distanceInMeters,
        "dificulty": finalTrail.dificulty,
      });
    });
